...
if (isset($_GET['query'])) {
    ...
    $sql = "SELECT patient.id_patient, id_consultation,nom,postnom,prenom,lib_categ as categorie 
    FROM consultation
    ...
    if ($stmt->rowCount() > 0) {
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo '<div class="result-item" data-id="' . htmlspecialchars($row['id_consultation']) . '" 
