      ...
      <div class="top">
        ...
        <div class="icon_top">
          ...
          <i class="uil uil-user-circle"></i>
                ...
                <div class="conteneur">
                  <h2 class="main-title">Adinistration de soin</h2>
                  <div class="form-container">
                    ...
                    <form action="TRAITEMENT/administrationsoin.php" method="POST" onsubmit="return confirmerEnregistrement();" class="formulaire">
                        ...
                        <h2 class="form-title">Détails sur le soin administré</h2>
                            
                            
                              <div class="input-box">
                                <label for="">Date et heure de soin</label>
                                  <input type="datetime-local" name="date_heure_soin" placeholder="Date et heure du soin" required>
                              </div>
                              <div class="input-box">
                              <label for="">Type de soin</label>
                            ...
                            <br>
                            <textarea name="description_soin" placeholder="Description détaillée du soin" required></textarea>
                            <div class="colonne">
                                <div class="input-box">
                                  <input type="text" name="duree_soin" placeholder="Durée du soin (en minutes)" required>
                                </div>
                            </div><br>
                            <textarea name="observations" placeholder="Observations cliniques et commentaires" required></textarea>
